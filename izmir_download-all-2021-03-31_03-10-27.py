...
#
#       python ./download-all-2021-03-31_13-10-27.py
#
#    Download all files in a Metalink/CSV: (downloaded from ASF Vertex)
#
#       python ./download-all-2021-03-31_13-10-27.py /path/to/downloads.metalink localmetalink.metalink localcsv.csv
#
...
class bulk_downloader:
    def __init__(self):
        ...
        self.files = [ "https://datapool.asf.alaska.edu/SLC/SB/S1B_IW_SLC__1SDV_20210104T160647_20210104T160714_025007_02F9ED_C173.zip",
